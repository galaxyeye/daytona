...
go build \
    -ldflags "-X 'github.com/galaxyeye/daytona/cli/internal.Version=${DAYTONA_VERSION}' \
    -X 'github.com/galaxyeye/daytona/cli/internal.DaytonaApiUrl=${DAYTONA_API_URL}' \
    -X 'github.com/galaxyeye/daytona/cli/internal.Auth0Domain=${DAYTONA_AUTH0_DOMAIN}' \
    -X 'github.com/galaxyeye/daytona/cli/internal.Auth0ClientId=${DAYTONA_AUTH0_CLIENT_ID}' \
    -X 'github.com/galaxyeye/daytona/cli/internal.Auth0ClientSecret=${DAYTONA_AUTH0_CLIENT_SECRET}' \
    -X 'github.com/galaxyeye/daytona/cli/internal.Auth0CallbackPort=${DAYTONA_AUTH0_CALLBACK_PORT}' \
    -X 'github.com/galaxyeye/daytona/cli/internal.Auth0Audience=${DAYTONA_AUTH0_AUDIENCE}'" \
